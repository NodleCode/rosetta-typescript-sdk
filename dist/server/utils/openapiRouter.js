...
function openApiRouter() {
    ...
    return function (request, response, next) { return __awaiter(_this, void 0, void 0, function () {
        var controllerName, serviceName, apiController, controllerOperation, error_1, err;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    controllerName = request.openapi.schema['x-openapi-router-controller'];
                    serviceName = request.openapi.schema['x-openapi-router-service'];
                    if (!(!controllers_1["default"][controllerName] || controllers_1["default"][controllerName] === undefined)) return [3 /*break*/, 1];
                    handleError("request sent to controller '" + controllerName + "' which has not been defined", request, response, next);
                    return [3 /*break*/, 3];
                case 1:
                    apiController = new controllers_1["default"][controllerName](services_1["default"][serviceName]);
                    controllerOperation = request.openapi.schema.operationId;
                    return [4 /*yield*/, apiController[controllerOperation](request, response, next)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                ...
                case 4:
                    ...
                    err = { code: 500, error: error_1.message };
