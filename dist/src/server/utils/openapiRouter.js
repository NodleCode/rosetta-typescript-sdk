...
function openApiRouter() {
    return async (request, response, next) => {
        try {
            ...
            if (!controllers_1.default[controllerName] || controllers_1.default[controllerName] === undefined) {
                handleError(`request sent to controller '${controllerName}' which has not been defined`, request, response, next);
            }
            else {
                const apiController = new controllers_1.default[controllerName](services_1.default[serviceName]);
