 ...
 */
export declare type CurveType = 'secp256k1' | 'secp256r1' | 'edwards25519' | 'tweedle';
/**
 ...
 */
export declare type ExemptionType = 'greater_or_equal' | 'less_or_equal' | 'dynamic';
/**
 ...
 */
export declare type SignatureType = 'ecdsa' | 'ecdsa_recovery' | 'ed25519' | 'schnorr_1' | 'schnorr_poseidon';
/**
