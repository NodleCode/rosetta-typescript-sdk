import { BlockRequest, BlockResponse, BlockTransactionRequest, BlockTransactionResponse, Params } from 'types';
/**
 * Get a Block
 ...
 * */
export declare const block: (params: Params<BlockRequest>) => Promise<BlockResponse>;
/**
 ...
 * */
export declare const blockTransaction: (params: Params<BlockTransactionRequest>) => Promise<BlockTransactionResponse>;
