...
class RosettaAsserter {
    ...
    static MinUnixEpoch = 946713600000; // 01/01/2000 at 12:00:00 AM.
    static MaxUnixEpoch = 2209017600000; // 01/01/2040 at 12:00:00 AM.
    constructor(
        {
            operationTypes = [],
            operationStatuses = [],
        ...
        }: AsserterConstructor = {} as AsserterConstructor
    ) {
     ...
     */
    SupportedNetworks(supportedNetworks: NetworkIdentifier[]) {
        ...
        for (const network of supportedNetworks) {
            ...
            if (parsedNetworks.includes(Hash(network))) {
                throw new AsserterError(
                    `SupportedNetwork has a duplicate: ${JSON.stringify(
                        network
                    )}`
                );
            }
     ...
     */
    ValidSupportedNetwork(requestNetwork: NetworkIdentifier) {
    ...
    AccountBalanceRequest(accountBalanceRequest: AccountBalanceRequest) {
        ...
        if (!this.historicalBalanceLookup) {
            throw new AsserterError(
                `historical balance loopup is not supported`
            );
        }
     ...
     *     is invalid.
     */
    BlockTransactionRequest(blockTransactionRequest: BlockTransactionRequest) {
        ...
        this.TransactionIdentifier(
            blockTransactionRequest.transaction_identifier
        );
    }
    ...
    ConstructionSubmitRequest(
        ...
        if (constructionSubmitRequest == null) {
            throw new AsserterError(
                'ConstructionSubmitRequest.options is null'
            );
        }
        ...
        if (!constructionSubmitRequest.signed_transaction) {
            throw new AsserterError(
                'ConstructionSubmitRequest.signed_transaction is empty'
            );
        }
    }
    ...
    MempoolTransactionRequest(
        ...
        this.TransactionIdentifier(
            mempoolTransactionRequest.transaction_identifier
        );
    }
     ...
     */
    MetadataRequest(metadataRequest: MetadataRequest) {
    ...
    ConstructionMetadataResponse(
        ...
        if (constructionMetadataResponse == null) {
            throw new AsserterError(
                'ConstructionMetadataResponse cannot be null'
            );
        }

        if (constructionMetadataResponse.metadata == null) {
            throw new AsserterError(
                'ConstructionMetadataResponse.metadata is null'
            );
        }
    }
    ...
    TransactionIdentifierResponse(
        ...
        if (transactionIdentifierResponse == null) {
            throw new AsserterError(
                'transactionIdentifierResponse cannot be null'
            );
        }

        // Note, this is not in the reference implementation (Go)
        this.TransactionIdentifier(
            transactionIdentifierResponse.transaction_identifier
        );
    }
    ...
    ConstructionCombineResponse(
        ...
        if (constructionCombineResponse == null) {
            throw new AsserterError(
                'constructionCombineResponse cannot be null'
            );
        }

        if (
            typeof constructionCombineResponse.signed_transaction !== 'string'
        ) {
            throw new AsserterError(
                'constructionCombineResponse.signed_transaction must be a string'
            );
        }

        if (!constructionCombineResponse.signed_transaction) {
            throw new AsserterError(
                'constructionCombineResponse.signed_transaction cannot be empty'
            );
        }
    }
    ...
    ConstructionDeriveResponse(
        ...
        if (constructionDeriveResponse == null) {
            throw new AsserterError(
                'constructionDeriveResponse cannot be null'
            );
        }

        if (typeof constructionDeriveResponse.address !== 'string') {
            throw new AsserterError(
                'constructionDeriveResponse.address must be a string'
            );
        }

        if (!constructionDeriveResponse.address) {
            throw new AsserterError(
                'constructionDeriveResponse.address cannot be empty'
            );
        }
    }
    ...
    ConstructionPreprocessRequest(
        ...
        if (constructionPreprocessRequest == null) {
            throw new AsserterError(
                'constructionPreprocessRequest cannot be null'
            );
        }

        this.ValidSupportedNetwork(
            constructionPreprocessRequest.network_identifier
        );
    ...
    ConstructionPayloadsRequest(
        ...
        if (constructionPayloadsRequest == null) {
            throw new AsserterError(
                'constructionPayloadsRequest cannot be null'
            );
        }
    ...
    ConstructionCombineRequest(
        ...
        if (constructionCombineRequest == null) {
            throw new AsserterError(
                'constructionCombineRequest cannot be null'
            );
        }
     ...
     */
    ConstructionHashRequest(constructionHashRequest: ConstructionHashRequest) {
    ...
    ConstructionParseResponse(
        ...
        if (!signed) {
            if (
                Array.isArray(constructionParseResponse.signers) &&
                constructionParseResponse.signers.length > 0
            ) {
                throw new AsserterError(
        ...
        for (
            let i = 0;
            i < (constructionParseResponse.signers || []).length;
            ++i
        ) {
    ...
    ConstructionPayloadsResponse(
        ...
        if (constructionPayloadsResponse == null) {
            throw new AsserterError(
                'constructionPayloadsResponse cannot be null'
            );
        }
        ...
        for (let i = 0; i < constructionPayloadsResponse.payloads.length; ++i) {
            ...
            try {
                ...
                throw new AsserterError(
                    `Signing Payload ${i} is invalid: ${e.message}`
                );
            }
        }
    }
    ...
    PublicKey(publicKey: PublicKey) {
        ...
        if (!this.checkHex(publicKey.hex_bytes)) {
            throw new AsserterError(
                `hex_bytes must be a valid hexadecimal string`
            );
        }
        ...
        try {
            ...
            throw new AsserterError(
                `public key curve type is not supported: ${e.message}`
            );
        }
    }
    ...
    CurveType(curveType: CurveType) {
        switch (curveType) {
            ...
            default:
                throw new AsserterError(
                    `${JSON.stringify(curveType)} is not a supported CurveType`
                );
        }
    }
     ...
     */
    SigningPayload(signingPayload: SigningPayload) {
        ...
        try {
            ...
            throw new AsserterError(
                `signature payload type is not valid: ${e.message}`
            );
        }
    }
    ...
    Signatures(signatureArray: Signature[] = []) {
        ...
        for (let i = 0; i < signatureArray.length; ++i) {
            ...
            try {
                ...
                throw new AsserterError(
                    `signature ${i} has invalid signing payload: ${e.message}`
                );
            }
            ...
            try {
                ...
                throw new AsserterError(
                    `signature ${i} has invalid public key: ${e.message}`
                );
            }
            ...
            try {
                ...
                throw new AsserterError(
                    `signature ${i} has invalid signature type: ${e.message}`
                );
            }
        ...
        switch (signatureType) {
            ...
            default:
                throw new AsserterError(
                    `${JSON.stringify(
                        signatureType
                    )} is not a supported SignatureType`
                );
        }
    }
    ...
    NetworkIdentifier(networkIdentifier: NetworkIdentifier) {
        ...
        return this.SubNetworkIdentifier(
            networkIdentifier.sub_network_identifier
        );
    }
     ...
     */
    SubNetworkIdentifier(subnetworkIdentifier: SubNetworkIdentifier) {
        ...
        if (!this.validString(subnetworkIdentifier.network)) {
            throw new AsserterError(
                'NetworkIdentifier.sub_network_identifier.network is missing'
            );
        }
    }
    ...
    Version(version: Version) {
        ...
        if (
            version.middleware_version != null &&
    ...
    StringArray(name: string, array: string[]) {
        ...
        for (const element of array) {
            ...
            if (existing.includes(element)) {
                throw new AsserterError(
                    `${name} contains a duplicate element: ${element}`
                );
            }
     ...
     */
    Timestamp(timestamp: number = 0) {
        if (timestamp < RosettaAsserter.MinUnixEpoch) {
            throw new AsserterError(
                `Timestamp ${timestamp} is before 01/01/2000`
            );
        } else if (timestamp > RosettaAsserter.MaxUnixEpoch) {
            throw new AsserterError(
                `Timestamp ${timestamp} is after 01/01/2040`
            );
        } else {
            return null;
        }
     ...
     */
    NetworkStatusResponse(networkStatusResponse: NetworkStatusResponse) {
    ...
    OperationStatuses(operationStatuses: OperationStatus[]) {
        ...
        if (!foundSuccessful) {
            throw new AsserterError(
                'No successful Allow.operation_statuses found'
            );
        }
     ...
     */
    NetworkOptionsResponse(networkOptionsResponse: NetworkOptionsResponse) {
     ...
     */
    NetworkListResponse(networkListResponse: NetworkListResponse) {
        ...
        for (const network of networkListResponse.network_identifiers) {
            ...
            if (this.containsNetworkIdentifier(existingNetworks, network)) {
                throw new AsserterError(
                    'NetworkListResponse.Network contains duplicated'
                );
            }
    ...
    assertBalanceAmounts(amountsArray: Amount[]) {
        ...
        for (const amount of amountsArray) {
            ...
            if (containsCurrency) {
                throw new AsserterError(
                    `Currency ${amount.currency.symbol} used in balance multiple times`
                );
            }
    ...
    Amount(amount: Amount) {
        ...
        if (!/^-?[0-9]+$/.test(amount.value)) {
            throw new AsserterError(
                `Amount.value is not an integer: ${amount.value}`
            );
        }
        ...
        if (amount.currency.decimals < 0) {
            throw new AsserterError(
                `Amount.currency.decimals must be positive. Found: ${amount.currency.decimals}`
            );
        }
    }
     ...
     */
    CoinIdentifier(coinIdentifier: CoinIdentifier) {
     ...
     */
    CoinAction(coinAction: CoinAction) {
        switch (coinAction) {
            ...
            default:
                throw new AsserterError(
                    `${JSON.stringify(coinAction)} is not a valid coin action`
                );
        }
    }
    ...
    Coins(coinArray: Coin[]) {
        ...
        for (const coin of coinArray) {
            ...
            if (ids[coin.coin_identifier.identifier]) {
                throw new AsserterError(
                    `duplicate coin identifier detected: ` +
    ...
    OperationIdentifier(
        ...
        if (typeof index !== 'number') {
            throw new AsserterError(
                'OperationIdentifier: index must be a number'
            );
        }
        ...
        if (
            operationIdentifier.network_index != null &&
            operationIdentifier.network_index < 0
        ) {
            throw new AsserterError(
                'OperationIdentifier.network_index is invalid'
            );
        }
    }
    ...
    OperationStatus(status: string) {
        ...
        if (this.operationStatusMap[status] == null) {
            throw new AsserterError(
                `OperationStatus.status ${status} is not valid`
            );
        }
    }
    ...
    Operation(operation: Operation, index: number, construction = false) {
        if (operation == null) {
        ...
        try {
            ...
            throw new AsserterError(
                `Operation.identifier is invalid in operation ${index}: ${e.message}`
            );
        }
        ...
        try {
            ...
            throw new AsserterError(
                `Operation.type is invalid in operation ${index}: ${e.message}`
            );
        }
        ...
        if (construction) {
            ...
            try {
                ...
                throw new AsserterError(
                    `Operation.status is invalid in operation ${index}: ${e.message}`
                );
            }
        }
        ...
        try {
            ...
            throw new AsserterError(
                `operation.account is invalid in operation ${index}: ${e.message}`
            );
        }
        ...
        try {
            ...
            throw new AsserterError(
                `operation.amount is invalid in operation ${index}: ${e.message}`
            );
        }
        ...
        try {
            ...
            throw new AsserterError(
                `operation.coin_change is invalid in operation ${index}: ${e.message}`
            );
        }
    }
    ...
    PartialBlockIdentifier(partialBlockIdentifier: PartialBlockIdentifier) {
        if (partialBlockIdentifier == null) {
        ...
        for (let i = 0; i < operations.length; ++i) {
            ...
            for (const relatedOperation of operation.related_operations) {
                if (
                    ...
                    throw new AsserterError(
                        `Related operation index ${relatedOperation.index}` +
                ...
                if (relatedIndices.includes(relatedOperation.index)) {
                    throw new AsserterError(
                        `Found duplicate related operation index` +
    ...
    Transaction(transaction: Transaction) {
        ...
        try {
            ...
            throw new AsserterError(
                `Invalid operation in transaction ` +
    ...
    static NewClientWithFile(filePath: fs.PathLike | number) {
    ...
    OperationSuccessful(operation: Operation) {
        const status = this.operationStatusMap[operation.status];

        if (status == null) {
            throw new AsserterError(
                `${operation.status} not found in possible statuses`
            );
        }
